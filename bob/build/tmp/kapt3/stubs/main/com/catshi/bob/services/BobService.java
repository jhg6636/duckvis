...
public class BobService implements com.catshi.bob.services.Bob {
    ...
    @org.springframework.transaction.annotation.Transactional
    public void leaveFirstTicketsOnly(@org.jetbrains.annotations.NotNull
    com.catshi.bob.types.BobTimeType bobTimeType) {
    }
    
    private void checkBobTeamMatched(com.catshi.bob.types.BobTimeType bobTimeType, int waitingTicketNumber) {
    }
    
    private void markFirstTicket(com.catshi.bob.types.BobTimeType bobTimeType) {
    }
